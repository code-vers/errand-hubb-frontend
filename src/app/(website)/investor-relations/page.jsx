          ...
          <div className='flex-1 z-10'>
            ...
            <div className='mb-8'>
              <div className='mb-4'>
                ...
                >
                  <circle cx='28' cy='28' r='26' stroke='#063b5c' strokeWidth='2' fill='none' />
                  <path
            ...
            <blockquote className='text-lg md:text-xl text-[#111111] font-medium leading-relaxed mb-8 max-w-lg'>
              ...
              <br />
              <br />
              We are currently seeking investors interested in equity ownership opportunities in a
              rapidly growing company focused on transforming the errand and task marketplace."
            </blockquote>
            ...
            <div className='mb-8 space-y-3'>
              <p className='text-base md:text-lg text-[#111111] leading-snug font-semibold'>
                ...
                <span className='text-[#063b5c] text-xl md:text-2xl ml-1'>$6.2M</span>
              </p>
              <p className='text-base md:text-lg text-[#111111] leading-snug font-semibold'>
                Long-Term Revenue Projection 2033:{' '}
                <span className='text-[#063b5c] text-xl md:text-2xl ml-1'>$60M+ Annually</span>
              </p>
            </div>
